...
console = Console()
db = None  # Definir db globalmente para evitar errores de referencia
...
def main():
    """Función principal para la conexión y ejecución de módulos"""
    global db
    load_dotenv()
...
if __name__ == "__main__":
    main()  # Llamar la función principal al ejecutar el script
